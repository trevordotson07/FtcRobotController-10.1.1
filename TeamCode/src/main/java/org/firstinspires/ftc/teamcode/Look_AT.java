...
@Autonomous(name= "Look_AT", group="14174")
@Disabled
public class Look_AT extends LinearOpMode {
    ...
    //slides rotation numbers
    private int slidesdown = 0;
    private int slidesup = 280;
